...
<script lang="ts">
  ...
  name: "Jordan Taylor",
  role: "Founder & CEO",
  image: "/generated/image-a-portrait-headshot-of-a-tech-startup-fo.webp"
};
</script>
...
<section bind:this={sectionRef} {...props}>
	<div class="section-px section-py container mx-auto">
        ...
        text={`"I started this company because teams were wasting hours on tasks that should take minutes. Software should help you work, not get in the way."`}
      />
